 ...
 * */
export const validateCollectionsAccountHolderStatusSuccessResponse = (
...
/**
 * Mock response from validate account holder status
 *
 * @property {boolean} result - The result.
 * */
export const mockResponseFromValidateCollectionsAccountHolderStatus: ValidateAccountHolderStatusResponsePayload = {
  result: true,
};

/**
 * Mock request body for ValidateAccountHolderStatusMockJson
 *
 ...
 * */
export const validateCollectionsAccountHolderStatusMockJson: InitiateValidateAccountHolderStatusRequestDto = {
...
export const mockResponseFromCollectionsValidateAccountHolderWithAccountNotActive: ValidateAccountHolderStatusResponsePayload = {
  result: false,
};
