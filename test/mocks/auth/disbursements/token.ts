 ...
 * */
export const createDisburementTokenSuccessResponse = (payload: CreateTokenRequestDto): CreateTokenResponse => {
  return {
 ...
 * @property {number} baseUrl - Mtn base url
 * */
export const createDisbursementTokenMockJson = {
