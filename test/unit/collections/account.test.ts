...
import { validateAccountHolderStatusForCollections } from '../../../src/modules/collections/account';
...
describe('validateAccountHolderStatusForCollections', () => {
  it('should call validateAccountHolderStatusForCollections with correct parameters', async () => {
    ...
    await validateAccountHolderStatusForCollections(dto);
